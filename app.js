...
app.post("/",function(req,res){
  // console.log();
  const appid="73f810fadf4f499726988df0e79a9732";
  ...
  https.get(url,function(response){
    ...
    response.on("data",function(data){
      ...
      const wurl="https://api.openweathermap.org/data/2.5/weather?lat="+lat+"&lon="+lon+"&appid=73f810fadf4f499726988df0e79a9732&units=metric";
